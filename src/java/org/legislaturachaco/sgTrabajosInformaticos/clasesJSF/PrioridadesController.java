...
import org.legislaturachaco.sgTrabajosInformaticos.sessionBeans.PrioridadesFacade;
...
public class PrioridadesController implements Serializable {
    ...
    @EJB
    private org.legislaturachaco.sgTrabajosInformaticos.sessionBeans.PrioridadesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PrioridadesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("PrioridadesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("PrioridadesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
