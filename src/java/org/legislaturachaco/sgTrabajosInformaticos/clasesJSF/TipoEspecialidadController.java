...
import org.legislaturachaco.sgTrabajosInformaticos.entidades.TipoEspecialidad;
...
import org.legislaturachaco.sgTrabajosInformaticos.sessionBeans.TipoEspecialidadFacade;
...
@Named("tipoEspecialidadController")
@SessionScoped
public class TipoEspecialidadController implements Serializable {

    @EJB
    private org.legislaturachaco.sgTrabajosInformaticos.sessionBeans.TipoEspecialidadFacade ejbFacade;
    ...
    public TipoEspecialidad getTipoEspecialidad(java.lang.Integer id) {
    ...
    public static class TipoEspecialidadControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getTipoEspecialidad(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoEspecialidad) {
                ...
                return getStringKey(o.getIdTipoEspecialidad());
            } else {
